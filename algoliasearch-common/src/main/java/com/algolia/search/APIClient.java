...
public class APIClient {
   ...
   */
  public <T> Index<T> initIndex(String name, Class<T> klass) {
   ...
   * @return The initialized index
   */
  public Index<?> initIndex(String name) {
   ...
   * @throws AlgoliaException
   */
  public List<Log> getLogs(Integer offset, Integer length, LogType logType) throws AlgoliaException {
   ...
   * @throws AlgoliaException
   */
  public String generateSecuredApiKey(String privateApiKey, Query query) throws AlgoliaException {
   ...
   * @throws AlgoliaException
   */
  public String generateSecuredApiKey(String privateApiKey, Query query, String userToken) throws AlgoliaException {
  ...
  public <T> void waitTask(String indexName, GenericTask<T> task, long timeToWait) throws AlgoliaException {
    while (true) {
   ...
   * @throws AlgoliaException
   */
  public TasksMultipleIndex batch(List<BatchOperation> operations) throws AlgoliaException {
  ...
  TaskSingleIndex partialUpdate(String indexName, PartialUpdateOperation operation) throws AlgoliaException {
    return httpClient.requestWithRetry(
      HttpMethod.POST,
      false,
